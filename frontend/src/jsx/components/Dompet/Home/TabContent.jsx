...
const TransactionsData = [
	{
		icons: <IconSuccess />,
		title: 'Panel Batch #PG-1021',
		subtitle: 'Panel Generation',
		date: 'Jan 12, 2026',
		price: '+450 Units',
	...
	{
		icons: <IconSuccess />,
		title: 'Dispatch ID #DP-334',
		subtitle: 'Panel Dispatch',
		date: 'Jan 13, 2026',
		price: '-320 Units',
		status: <StatusComplete />,
	},
